...
for FileNum = 1:maxFiles
    tempa(:,end+1) = plotCPIStack(eval([files{FileNum},'_sMatsI3']),files{FileNum},FileNum,maxFiles, total);
end
tempa(:,end+1) = zeros;
tempa(:,end+1) = zeros;
subplot(3,5,1);
...
tempa = [];
for FileNum = 1:maxFiles
    tempa(:, end+1) = plotConflict(eval([files{FileNum},'_sMatsI3']),files{FileNum},FileNum,maxFiles, total);
end
tempa(:,end+1) = zeros;
tempa(:,end+1) = zeros;
subplot(3,5,2);
...
tempa = [];
for FileNum = 1:maxFiles
    tempa(:, end+1) = plotSerialStall(eval([files{FileNum},'_sMatsI3']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,3);
bar(tempa', 'stack')
ylim([0,0.35]);
...
tempa = [];
for FileNum = 1:maxFiles
    tempa(:,end+1) = plotpCDR(eval([files{FileNum},'_sMatsI3']),files{FileNum},FileNum,maxFiles, total);
end
tempa(:,end+1) = zeros;
tempa(:,end+1) = zeros;
subplot(3,5,4);
...
tempa = [];
for FileNum = 1:maxFiles
    tempa(:,end+1) = plotBranchMiss(eval([files{FileNum},'_sMatsI3']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,5);
bar(tempa', 'stack')
ylim([0,0.01]);
...
tempa = [];
for FileNum = 1:maxFiles
    tempa(:,end+1) = plotIPC(eval([files{FileNum},'_sMatsI3']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,6);
bar(tempa', 'stack')
ylim([0,2]);
...
tempa = [];
for FileNum = 1:maxFiles
    tempa(:,end+1) = plotcriticalPathLength(eval([files{FileNum},'_sMatsI3']),files{FileNum},FileNum,maxFiles, total);
end
tempa(:,end+1) = zeros;
tempa(:,end+1) = zeros;
subplot(3,5,7);
...
tempa = [];
for FileNum = 1:maxFiles
    tempa(:,end+1) = plotL1DCacheMiss(eval([files{FileNum},'_sMatsI3']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,8);
bar(tempa', 'stack')
ylim([0,0.01]);
...
tempa = [];
for FileNum = 1:maxFiles
    tempa(:,end+1) = plotL1ICacheMiss(eval([files{FileNum},'_sMatsI3']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,9);
bar(tempa', 'stack')
ylim([0,0.02]);
...
tempa = [];
for FileNum = 1:maxFiles
    tempa(:,end+1) = plotL2ICacheMiss(eval([files{FileNum},'_sMatsI3']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,10);
bar(tempa', 'stack')
ylim([0,0.01]);
...
tempa = [];
for FileNum = 1:maxFiles
    tempa(:,end+1) = plotL2DCacheMiss(eval([files{FileNum},'_sMatsI3']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,11);
bar(tempa', 'stack')
ylim([0,0.01]);
...
tempa = [];
for FileNum = 1:maxFiles
    tempa(:,end+1) = plotInstMix(eval([files{FileNum},'_sMatsI3']),files{FileNum},FileNum,maxFiles, total);
end
tempa(:,end+1) = zeros;
tempa(:,end+1) = zeros;
subplot(3,5,12);
...
tempa = [];
for FileNum = 1:maxFiles
    tempa(:,end+1) = plotStackDist(eval([files{FileNum},'_sMatsI3']),files{FileNum},FileNum,maxFiles, total);
end
tempa(:,end+1) = zeros;
tempa(:,end+1) = zeros;
subplot(3,5,13);
...
legend('lqGDist0','lqGDist1','lqGDist2','lqGDist3','lqGDist4','lqGDist5','lqGDist6','lqGDist7','lqGDist8','lqGDist9','lqGDist10');

% plot the lqGDist
tempa = [];
for FileNum = 1:maxFiles
    tempa(:,end+1) = plotstGDist(eval([files{FileNum},'_sMatsI3']),files{FileNum},FileNum,maxFiles, total);
end
tempa(:,end+1) = zeros;
tempa(:,end+1) = zeros;
subplot(3,5,14);
...
legend('stGDist0','stGDist1','stGDist2','stGDist3','stGDist4','stGDist5','stGDist6','stGDist7','stGDist8','stGDist9','stGDist10');

% plot the lqLDist
tempa = [];
for FileNum = 1:maxFiles
    tempa(:,end+1) = plotlqLDist(eval([files{FileNum},'_sMatsI3']),files{FileNum},FileNum,maxFiles, total);
end
tempa(:,end+1) = zeros;
tempa(:,end+1) = zeros;
subplot(3,5,15);
...
legend('lqLDist0','lqLDist1','lqLDist2','lqLDist3','lqLDist4','lqLDist5','lqLDist6','lqLDist7','lqLDist8','lqLDist9','lqLDist10');
