...
for FileNum = 1:maxFiles
    tempa = plotCPIStack(eval([files{FileNum},'_sMatsI4']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,1);
bar(tempa', 'stack')
...
tempa = [];
for FileNum = 1:maxFiles
    tempa = plotConflict(eval([files{FileNum},'_sMatsI4']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,2);
bar(tempa', 'stack');
...
tempa = [];
for FileNum = 1:maxFiles
    tempa = plotSerialStall(eval([files{FileNum},'_sMatsI4']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,3);
bar(tempa', 'stack')
%ylim([0,0.35]);
...
tempa = [];
for FileNum = 1:maxFiles
    tempa = plotpCDR(eval([files{FileNum},'_sMatsI4']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,4);
bar(tempa', 'stack')
...
tempa = [];
for FileNum = 1:maxFiles
    tempa = plotBranchMiss(eval([files{FileNum},'_sMatsI4']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,5);
bar(tempa', 'stack')
...
tempa = [];
for FileNum = 1:maxFiles
    tempa = plotIPC(eval([files{FileNum},'_sMatsI4']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,6);
bar(tempa', 'stack')
%ylim([0,2]);
...
tempa = [];
for FileNum = 1:maxFiles
    tempa = plotcriticalPathLength(eval([files{FileNum},'_sMatsI4']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,7);
bar(tempa', 'stack')
...
tempa = [];
for FileNum = 1:maxFiles
    tempa = plotL1DCacheMiss(eval([files{FileNum},'_sMatsI4']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,8);
bar(tempa', 'stack')
...
tempa = [];
for FileNum = 1:maxFiles
    tempa = plotL1ICacheMiss(eval([files{FileNum},'_sMatsI4']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,9);
bar(tempa', 'stack')
...
tempa = [];
for FileNum = 1:maxFiles
    tempa = plotL2ICacheMiss(eval([files{FileNum},'_sMatsI4']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,10);
bar(tempa', 'stack')
...
tempa = [];
for FileNum = 1:maxFiles
    tempa = plotL2DCacheMiss(eval([files{FileNum},'_sMatsI4']),files{FileNum},FileNum,maxFiles,total);
end
subplot(3,5,11);
bar(tempa', 'stack')
...
tempa = [];
for FileNum = 1:maxFiles
    tempa = plotInstMix(eval([files{FileNum},'_sMatsI4']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,12);
bar(tempa', 'stack')
...
tempa = [];
for FileNum = 1:maxFiles
    tempa = plotStackDist(eval([files{FileNum},'_sMatsI4']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,13);
bar(tempa', 'stack')
...
tempa = [];
for FileNum = 1:maxFiles
    tempa = plotstGDist(eval([files{FileNum},'_sMatsI4']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,14);
bar(tempa', 'stack')
...
tempa = [];
for FileNum = 1:maxFiles
    tempa = plotlqLDist(eval([files{FileNum},'_sMatsI4']),files{FileNum},FileNum,maxFiles, total);
end
subplot(3,5,15);
bar(tempa', 'stack')
